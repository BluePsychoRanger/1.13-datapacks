...
execute as @e[tag=szn_ice] at @s unless block ~ ~ ~ ice unless block ~ ~ ~ packed_ice unless block ~ ~ ~ blue_ice run kill @s
execute as @e[tag=szn_packed_ice] at @s unless block ~ ~ ~ packed_ice unless block ~ ~ ~ blue_ice run kill @s
execute as @e[tag=szn_blue_ice] at @s unless unless block ~ ~ ~ blue_ice run kill @s
