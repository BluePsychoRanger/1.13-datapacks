...
execute if entity @a[scores={szn_mineLeavesO=1..}] at @a[scores={szn_mineLeavesO=1..}] run kill @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:oak_sapling",Count:1b}},limit=1,distance=..7]
execute if entity @a[scores={szn_mineLeavesO=1..}] at @a[scores={szn_mineLeavesO=1..}] run kill @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:apple",Count:1b}},limit=1,distance=..7]
execute if entity @a[scores={szn_mineLeavesB=1..}] at @a[scores={szn_mineLeavesB=1..}] run kill @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:birch_sapling",Count:1b}},limit=1,distance=..7]
execute if entity @a[scores={szn_mineLeavesD=1..}] at @a[scores={szn_mineLeavesD=1..}] run kill @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:dark_oak_sapling",Count:1b}},limit=1,distance=..7]
execute if entity @a[scores={szn_mineLeavesD=1..}] at @a[scores={szn_mineLeavesD=1..}] run kill @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:apple",Count:1b}},limit=1,distance=..7]


execute if entity @a[scores={szn_mineLeavesO=1..}] if score #randval szn_rng matches 0..3 at @a[scores={szn_mineLeavesO=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:oak_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:oak_leaves",Count:1b}},limit=1,distance=..7] {Item:{id:"minecraft:stick",Count:2b}}
execute if entity @a[scores={szn_mineLeavesO=1..}] if score #randval szn_rng matches 4..8 at @a[scores={szn_mineLeavesO=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:oak_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:oak_leaves",Count:1b}},limit=1,distance=..7] {Item:{id:"minecraft:stick",Count:1b}}

execute if entity @a[scores={szn_mineLeavesB=1..}] if score #randval szn_rng matches 0..3 at @a[scores={szn_mineLeavesB=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:birch_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:birch_leaves",Count:1b}},limit=1,distance=..7] {id:"minecraft:stick",Item:{Count:2b}}
execute if entity @a[scores={szn_mineLeavesB=1..}] if score #randval szn_rng matches 4..8 at @a[scores={szn_mineLeavesB=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:birch_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:birch_leaves",Count:1b}},limit=1,distance=..7] {id:"minecraft:stick",Item:{Count:1b}}

execute if entity @a[scores={szn_mineLeavesD=1..}] if score #randval szn_rng matches 0..3 at @a[scores={szn_mineLeavesD=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:dark_oak_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:dark_oak_leaves",Count:1b}},limit=1,distance=..7] {id:"minecraft:stick",Item:{Count:2b}}
execute if entity @a[scores={szn_mineLeavesD=1..}] if score #randval szn_rng matches 4..8 at @a[scores={szn_mineLeavesD=1..}] if entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:dark_oak_leaves",Count:1b}},distance=..7] run data merge entity @e[type=item,tag=!szn_checked,nbt={Item:{id:"minecraft:dark_oak_leaves",Count:1b}},limit=1,distance=..7] {id:"minecraft:stick",Item:{Count:1b}}
